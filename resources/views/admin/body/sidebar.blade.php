...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
            ...
            <div class="ulogo">
                <a href="{{ url('admin/dashboard') }}">
                    ...
                    <div class="d-flex align-items-center justify-content-center">
                        <img src="{{ asset('backend/images/art_logo.png') }}" alt="" style="width: 50px;">
                        <h3><b>Art Sharing App </b> Admin</h3>
                    </div>
                </a>
            </div>
        </div>
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview {{ ($prefix == '/art')? 'active':'' }}">
                <a href="#">
                    <i data-feather="message-circle"></i>
                    <span>Art</span>
                    <span class="pull-right-container">
              <i class="fa fa-angle-right pull-right"></i>
                ...
                <ul class="treeview-menu">
                    <li class="{{ ($route == 'all.art')? 'active':'' }}">
                        <a href="{{ route('all.art') }}"><i class="ti-more"></i>All Art's</a>
                    </li>
