<div class="bgded overlay row4" style="background-image:url('{{ asset('assets/frontend/images/demo/backgrounds/01.png') }}');">
    <footer id="footer" class="hoc clear">
        <!-- ################################################################################################ -->
        <div class="center btmspace-50">
            <img src="{{ asset('art_logo.png') }}" style="width: 100px"><br>
            <ul class="faico clear">
                <li><a class="faicon-dribble" href="#"><i class="fab fa-dribbble"></i></a></li>
                <li><a class="faicon-facebook" href="https://www.facebook.com/Fahadulislam181253" target="_blank"><i class="fab fa-facebook"></i></a></li>
